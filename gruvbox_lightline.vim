...
if exists('g:lightline')
  ...
  let s:p.normal.left = [ [ s:fg4, s:bg0, 'bold' ], [ s:bg2, s:bg0 ] ]
  let s:p.normal.right = [ [ s:fg4, s:bg0 ], [ s:bg2, s:bg0 ] ]
  let s:p.normal.middle = [ [ s:fg4, s:bg0 ] ]
  let s:p.inactive.right = [ [ s:bg4, s:bg1 ], [ s:bg4, s:bg1 ] ]
  let s:p.inactive.left =  [ [ s:bg4, s:bg1 ], [ s:bg4, s:bg1 ] ]
  let s:p.inactive.middle = [ [ s:bg4, s:bg1 ] ]
  let s:p.insert.left = [ [ s:blue, s:bg0, 'bold' ], [ s:fg1, s:bg0 ] ]
  let s:p.insert.right = [ [ s:fg4, s:bg0 ], [ s:fg4, s:bg0 ] ]
  ...
  let s:p.visual.left = [ [ s:orange, s:bg0, 'bold' ], [ s:fg1, s:bg0 ] ]
  let s:p.visual.right = [ [ s:orange, s:bg0 ], [ s:bg4, s:bg0 ] ]
  let s:p.visual.middle = [ [ s:fg4, s:bg0 ] ]
  let s:p.tabline.left = [ [ s:fg4, s:bg2 ] ]
  let s:p.tabline.tabsel = [ [ s:yellow, s:bg0 ] ]
  let s:p.tabline.middle = [ [ s:bg0, s:bg0 ] ]
  let s:p.tabline.right = [ [ s:bg0, s:orange ] ]
  let s:p.normal.error = [ [ s:orange, s:bg0 ] ]
  let s:p.normal.warning = [ [ s:yellow, s:bg0 ] ]
